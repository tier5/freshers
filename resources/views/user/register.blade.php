...
@section('content')
    <div class="container">
    <form action="{{route('postregister')}}" method="POST" class="form-horizontal" role="form" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="row">
                    <input type="password" class="form-control col-md-6 col-sm-6 col-xs-12" id="user_Confirmepassword" name="confirm_password" placeholder="Confirm Password" />
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="row">
                    <input type="date" class="form-control col-md-6 col-sm-6 col-xs-12" id="dateofbirth" name="date_of_birth"/>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="row">
                    <input type="number" class="form-control col-md-6 col-sm-6 col-xs-12" id="user_contactno" name="contact_no" placeholder="Contact No"/>
