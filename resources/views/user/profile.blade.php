...
<div class="container">
    ...
    @endif
        ...
        <div class="co-md-offset-3 col-md-6 col-sm-offset-3 col-sm-6 col-xs-12">
                    <div class="row">
                        <div class="col-xs-12 col-sm-4"> <img src="uploads/profile_pic/{{$user->profile_picture}}" style="height: 128px; width: 128px" alt="Profile Picture" /></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6">{{$user->country.$user->contact_number}}</div>
                    </div>
                </div>
</div>
@endsection