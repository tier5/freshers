    ...
    <div class="main">
        ...
        <div class="container">
            ...
            @else
                <div class="centered">
                    <br><br><br><br><br>
                    <h1>Sorry No Meme Found <small>For create a meme Go to <a href="{{ route('meme.photo') }}"> <i class="fa fa-paint-brush fa-1x" aria-hidden="true">Create Meme</i></a></small></h1>
                    <br><br><br><br><br>
                </div>
            @endif
        </div>
