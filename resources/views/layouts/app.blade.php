...
<head>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/5.2.0/sweetalert2.min.css"></script>
...
<script language=JavaScript>
    ...
    function disableCtrlKeyCombination(e)
    {
        ...
        var forbiddenKeys = new Array('a', 'c', 'x', 'v','u');
        var key;
        var isCtrl;
        if(window.event)
        {
...
<footer>
    <div class="row text-center">
        <div class="col-lg-12">
            <p>Copyright &copy; Makingshitfunny.com {{ date('Y') }}</p>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
