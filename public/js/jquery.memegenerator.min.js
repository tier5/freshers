    ...
    var a = function (e, d) {
        ...
        this.ui = {
            createControls: function () {
                ...
                var i = c('<a href="#" class="mg-add-textbox">' + b.addTextbox + "</a>").appendTo(g);
                c(i).click(function (n) {
                    n.preventDefault();
                    var m = f.ui.createTextBox("", "center center").insertAfter(g.find(".mg-textbox").last());
                    if (f.settings.useBootstrap) {
                        f.ui.bootstrapify()
                    }
                    m.find("input[type=text]").first().focus();
                    f.settings.onNewTextBox.call(f, m)
                });
                var j = c('<a href="#" class="mg-advanced-settings-toggle">' + b.advancedSettings + "</a>").appendTo(g);
                var l = c('<div class="mg-advanced-settings"></div>').appendTo(g).hide();
                l.append(c('<div class="option"></div>').append(c('<input type="checkbox" class="mg-option-uppercase">')).append(c("<label>" + b.optionCapitalLetters + "</label>")));
                g.find(".mg-option-uppercase").prop("checked", f.userSettings.forceUppercase);
                g.find(".mg-option-uppercase").change(function (m) {
                    m.preventDefault();
                    f.userSettings.forceUppercase = c(this).is(":checked");
                    if (f.userSettings.forceUppercase) {
                        g.find(".mg-textbox-text").css("textTransform", "uppercase");
                        g.find(".mg-textbox-text").each(function () {
                            c(this).val(f.ui._strtoupper(c(this).val()))
                        });
                        f.events.onLayerChange()
                    } else {
                        g.find(".mg-textbox-text").css("textTransform", "none")
                    }
                });
                l.append(c('<div class="option"></div>').append(c('<input type="checkbox" class="mg-option-dragresize">')).append(c("<label>" + b.optionDragResize + "</label>")));
                g.find(".mg-option-dragresize").prop("checked", f.userSettings.dragResizeEnabled);
                g.find(".mg-option-dragresize").change(function (m) {
                    m.preventDefault();
                    f.userSettings.dragResizeEnabled = c(this).is(":checked");
                    f.ui.destroyPositionHelpers();
                    if (f.userSettings.dragResizeEnabled) {
                        g.find(".mg-textbox").each(function () {
                            f.ui.createPositionHelper(c(this))
                        })
                    }
                });
                l.append(c('<div class="option"></div>').append(c('<input type="checkbox" class="mg-option-drawing-above-text">')).append(c("<label>" + b.optionDrawingAboveText + "</label>")));
                g.find(".mg-option-drawing-above-text").prop("checked", f.userSettings.dragResizeEnabled);
                g.find(".mg-option-drawing-above-text").change(function (m) {
                    m.preventDefault();
                    f.userSettings.drawingAboveText = c(this).is(":checked");
                    if (f.userSettings.drawingAboveText) {
                        f.wrapper.find(".mg-canvas canvas, .mg-css-preview").css("zIndex", 3);
                        f.wrapper.find(".mg-canvas, .mg-canvas .mg-drawing-layer").css("zIndex", 4)
                    } else {
                        f.wrapper.find(".mg-canvas canvas, .mg-css-preview").css("zIndex", 4);
                        f.wrapper.find(".mg-canvas, .mg-canvas .mg-drawing-layer").css("zIndex", 3)
                    }
                });
                c(j).click(function (m) {
                    m.preventDefault();
                    l.slideToggle(200);
                    j.toggleClass("active")
                });
                var k;
                if (f.settings.toolboxSelector == null) {
                    var h = c('<a href="#" class="mg-toolbox-toggle">' + b.toolbox + "</a>").appendTo(g);
                    var k = c('<div class="mg-toolbox"></div>').appendTo(g).hide();
                    c(h).click(function (m) {
                        m.preventDefault();
                        k.slideToggle(200);
                        h.toggleClass("active")
                    })
                } else {
                    if (f.settings.toolboxSelector instanceof jQuery) {
                        k = f.settings.toolboxSelector
                    } else {
                        k = c(f.settings.toolboxSelector)
                    }
                }
                k.append('<div class="mg-toolbox-item"><button class="mg-drawing-toggle">' + b.drawingStart + "</button></div>");
                k.append('<div class="mg-toolbox-item"><input type="text" class="colorpicker" value="' + f.settings.defaultDrawingStyle.color + '"></div>');
                k.append('<div class="mg-toolbox-item"><input type="number" class="mg-drawing-line-width" value="' + f.settings.defaultDrawingStyle.lineWidth + '"></div>');
                k.append('<div class="mg-toolbox-item"><button class="mg-drawing-erase">' + b.drawingErase + "</button></div>");
                k.find(".mg-drawing-toggle").click(function () {
                    c(this).toggleClass("active");
                    if (c(this).hasClass("active")) {
                        c(this).html("Stop drawing");
                        f.drawing.enable()
                    } else {
                        c(this).html("Draw");
                        f.drawing.disable()
                ...
                k.find(".mg-drawing-line-width").on("change keyup", function () {
                    f.drawing.lineWidth = parseInt(c(this).val(), 10)
                });
                k.find(".mg-drawing-erase").click(function () {
                    f.drawing.erase()
                });
                k.find(".colorpicker").change(function () {
                    f.drawing.color = c(this).attr("value")
                });
                f.ui._bindColorpicker(k.find(".colorpicker"));
                return g
                ...
                var i = c('<div class="mg-textbox" data-layer="' + h + '" data-x="' + j[0] + '" data-y="' + j[1] + '" data-width="' + k + '" data-height="' + l + '"></div>');
                ...
                i.append(c('<input type="number" class="mg-textbox-border-width" value="' + f.settings.defaultTextStyle.borderWidth + '" step="' + f.settings.borderWidthStep + '" min="' + f.settings.minBorderWidth + '" max="' + f.settings.maxBorderWidth + '">'));
                f.canvasLayers.push(h);
                i.find(".mg-textbox-text, .mg-textbox-size, .mg-textbox-border-width").on("change keyup", function () {
                    if (f.userSettings.forceUppercase) {
                        c(this).val(f.ui._strtoupper(c(this).val()))
                    }
                ...
                h.draggable({
                    containment: f.wrapper.find("> .mg-image > img"), drag: function (k, l) {
                ...
                h.resizable({
                    containment: f.wrapper.find("> .mg-image > img"), resize: function (k, l) {
                        var j = f.wrapper.find("[data-layer='" + g + "']");
                ...
                f.helpersContainer.find("> div").each(function () {
                    ...
                    if (h.attr("data-x") && h.attr("data-y")) {
                        c(this).css({left: h.attr("data-x") * f.scale, top: h.attr("data-y") * f.scale})
                    }
                ...
                if (!g.find(".mg-advanced-settings-toggle").hasClass("btn")) {
                    g.find(".mg-advanced-settings-toggle, .mg-toolbox-toggle").addClass("btn btn-primary btn-block").wrap(c("<div></div>").addClass("row"));
                    g.find(".mg-advanced-settings, .mg-toolbox").addClass("row");
                    g.find(".mg-advanced-settings .option input").wrap('<div class="col-md-1"></div>');
                    g.find(".mg-advanced-settings .option label").wrap('<div class="col-md-11"></div>')
                }
                if (!g.find(".mg-drawing-toggle").hasClass("btn")) {
                    g.find(".mg-drawing-toggle, .mg-drawing-erase").addClass("btn btn-default btn-block");
                    g.find(".mg-toolbox-item").addClass("col-md-3")
                }
                ...
                if (f.settings.colorPicker == null && c.isFunction(c.fn.spectrum)) {
                    ...
                    g.spectrum({replacerClassName: "colorpickerReplacer", change: h, move: h})
                } else {
                ...
                f.canvasLayers.forEach(function (i) {
                    ...
                    if (j.hasClass("mg-textbox")) {
                        var l = {
                            ...
                            borderColor: j.find(".mg-textbox-border-color").attr("value"),
                            borderWidth: j.find(".mg-textbox-border-width").val() * g
                        };
                        var h = f.canvas.drawText(l.text, l.x, l.y, l.maxWidth, l.fontSize, l.font, l.color, l.borderColor, l.borderWidth, g);
        ...
        this.cssPreview = {
            enable: function () {
                ...
                f.canvasLayers.forEach(function (i) {
                    ...
                    if (j.hasClass("mg-textbox")) {
                        var k = {
                            ...
                            borderColor: j.find(".mg-textbox-border-color").attr("value"),
                            borderWidth: j.find(".mg-textbox-border-width").val() * f.scale
                        };
                        var h = f.cssPreview.drawText(k.text, k.x, k.y, k.maxWidth, k.fontSize, k.font, k.color, k.borderColor, k.borderWidth);
                        g.append(h);
                ...
                h.css({
                    ...
                    textAlign: "center",
                    lineHeight: p + "px",
                    textShadow: (function (q, s) {
                        var r = "";
                        [[-1, -1], [-1, 1], [1, -1], [1, 1]].forEach(function (u, t) {
                            r += u[0] * q + "px " + u[1] * q + "px 0 " + s;
                            if (t != 3) {
                                r += ","
                            }
                        });
        ...
        this.drawing = {
            ...
            prevY: 0,
            currY: 0,
            color: f.settings.defaultDrawingStyle.color,
            lineWidth: f.settings.defaultDrawingStyle.lineWidth,
            enable: function () {
                if (f.drawing.canvas == null) {
                    f.drawing.container = c('<div class="mg-drawing"></div>').appendTo(f.wrapper.find("> .mg-image"));
                    var g = c('<canvas class="mg-drawing-layer"></canvas>').attr("width", f.drawing.container.width()).attr("height", f.drawing.container.height()).appendTo(f.canvasContainer);
                    f.drawing.canvas = g[0];
                    f.drawing.initEvents()
                }
                f.drawing.enabled = true;
                f.drawing.container.show()
            },
            disable: function () {
                f.drawing.enabled = false;
                f.drawing.container.hide()
            },
            initEvents: function () {
                f.drawing.container[0].addEventListener("mousemove", function (g) {
                    f.drawing.handleAction("move", g)
                }, false);
                f.drawing.container[0].addEventListener("mousedown", function (g) {
                    f.drawing.handleAction("down", g)
                }, false);
                f.drawing.container[0].addEventListener("mouseup", function (g) {
                    f.drawing.handleAction("up", g)
                }, false);
                f.drawing.container[0].addEventListener("mouseout", function (g) {
                    f.drawing.handleAction("out", g)
                }, false)
            },
            draw: function () {
                var g = f.drawing.canvas.getContext("2d");
                g.beginPath();
                g.moveTo(f.drawing.prevX, f.drawing.prevY);
                g.lineTo(f.drawing.currX, f.drawing.currY);
                g.strokeStyle = f.drawing.color;
                g.lineWidth = f.drawing.lineWidth;
                g.stroke();
                g.closePath()
            },
            erase: function () {
                var g = f.drawing.canvas.getContext("2d");
                g.clearRect(0, 0, f.drawing.canvas.width, f.drawing.canvas.height)
            },
            handleAction: function (i, h) {
                if (f.drawing.enabled) {
                    var g = f.drawing.canvas.getContext("2d");
                    if (i == "down") {
                        f.drawing.prevX = f.drawing.currX;
                        f.drawing.prevY = f.drawing.currY;
                        f.drawing.currX = h.clientX - f.drawing.container.offset().left;
                        f.drawing.currY = h.clientY - f.drawing.container.offset().top;
                        f.drawing.flag = true;
                        g.beginPath();
                        g.fillStyle = f.drawing.color;
                        g.fillRect(f.drawing.currX, f.drawing.currY, 2, 2);
                        g.closePath()
                    } else {
                        if (i == "up" || i == "out") {
                            f.drawing.flag = false
                        } else {
                            if (i == "move") {
                                if (f.drawing.flag) {
                                    f.drawing.prevX = f.drawing.currX;
