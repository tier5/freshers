    ...
    public function shortnameToImageCallback($m)
    {
        if ((!is_array($m)) || (!isset($m[1])) || (empty($m[1]))) {
            ...
            if ($this->imageType == 'png')
            {
                ...
                {
                    return '<img style="width:15px; height:15px;" class="emojione" alt="'.$alt.'" src="'.$this->imagePathPNG.$filename.'.png'.$this->cacheBustParam.'"/>';
                }
            }
    ...
    public function asciiToImageCallback($m)
    {
        ...
        else
        {
            ...
            if ($this->imageType == 'png')
            {
                ...
                {
                    return $m[2].'<img style="width:15px; height:15px;" class="emojione" alt="'.$alt.'" src="'.$this->imagePathPNG.$unicode.'.png'.$this->cacheBustParam.'"/>';
                }
            }
