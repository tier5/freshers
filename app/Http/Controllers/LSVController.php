...
class LSVController extends Controller
{
	...
	public function likecomment(Request $request)
	{
		...
		$like_num   = Comment::where('id',$comment)->first()->likes;
		$dislike_num= Comment::where('id',$comment)->first()->dislikes;
	...
	public function likearticle(Request $request)
	{
		...
		$like_num=   Article::where('id',$article)->first()->likes;
		$dislike_num=Article::where('id',$article)->first()->dislikes;
		if($dislike_status != null)
		{
			$dislike_status->delete();
	...
	public function likereply(Request $request)
	{
		...
		$like_num=   Reply::where('id',$reply)->first()->likes;
		$dislike_num=Reply::where('id',$reply)->first()->dislikes;
		if($dislike_status != null)
		{
			$dislike_status->delete();
